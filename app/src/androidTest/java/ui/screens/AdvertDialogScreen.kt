...
object AdvertDialogScreen : KScreen<AdvertDialogScreen>() {

    override val layoutId: Int? = null
    override val viewClass: Class<*> = CustomDialogFragment::class.java

    val textDialog = KTextView { withText(R.string.dialog_fragment_message_add_advert) }
    val title = KTextView { withText(R.string.dialog_fragment_title_add_advert) }
